...
.sc-ico.bl{background:linear-gradient(135deg,#E8F0FE 0%,#D5E4FD 100%);color:#1E6FE5}
.sc-ico.gr{background:linear-gradient(135deg,#E6F9F0 0%,#CFF1E0 100%);color:#0D9C6B}
.sc-ico.am{background:linear-gradient(135deg,#FFF7E0 0%,#FDEFC0 100%);color:#C07000}
.sc-ico.pu{background:linear-gradient(135deg,#F2EEFF 0%,#E4DAFF 100%);color:#6C3CE0}
...
.sc-lbl{font-size:14px;font-weight:600;color:var(--t2);margin-bottom:8px;line-height:1.3;letter-spacing:.1px}
.sc-val{font-size:34px;font-weight:700;color:var(--t1);letter-spacing:-.8px;line-height:1.05;font-family:'Sarabun',sans-serif;font-variant-numeric:tabular-nums}
