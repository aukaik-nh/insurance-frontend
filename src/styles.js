...
.top-srch{
  ...
  width:280px;flex-shrink:0;transition:border-color .15s;
}
.top-srch:focus-within{border-color:var(--blue);background:var(--sur)}
.top-srch svg{color:var(--t3);flex-shrink:0}
.top-srch input{flex:1;border:none;background:transparent;outline:none;font-size:13px;font-family:inherit;color:var(--t1);min-width:0}
...
.pvp{
  width:46%;min-width:420px;max-width:700px;flex-shrink:0;
...
.sc-ico{width:44px;height:44px;border-radius:12px;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
...
.pg-dots{width:28px;height:34px;display:flex;align-items:center;justify-content:center;font-size:13px;color:var(--t3);user-select:none}
...
.pdf-preview-bar{padding:9px 13px;background:var(--sur);border-bottom:1px solid var(--brd);display:flex;align-items:center;gap:8px;font-size:12.5px;font-weight:600;color:var(--t2);flex-shrink:0;}
...
.pdf-preview-bar .pdf-size{font-size:11.5px;font-weight:400;color:var(--t3);flex-shrink:0;}
.pdf-zoom-btn{width:30px;height:30px;border-radius:7px;background:var(--sur2);border:1.5px solid var(--brd);color:var(--t2);cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:all .12s;}
...
.pdf-lb-bar{height:58px;background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.09);display:flex;align-items:center;gap:10px;padding:0 20px;color:#E2E8F0;flex-shrink:0;}
.pdf-lb-bar .pdf-lb-name{flex:1;font-size:14px;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
.pdf-lb-bar .pdf-lb-size{font-size:12px;color:#94A3B8;font-weight:400}
.pdf-lb-btn{height:36px;padding:0 13px;border-radius:8px;background:rgba(255,255,255,.09);border:1px solid rgba(255,255,255,.12);color:#fff;font-size:13px;font-weight:600;cursor:pointer;display:inline-flex;align-items:center;gap:6px;transition:all .12s;font-family:'Sarabun','Noto Sans Thai',sans-serif;}
...
.pdf-lb-zoom{font-size:12.5px;font-variant-numeric:tabular-nums;color:#E2E8F0;min-width:48px;text-align:center;padding:0 6px;}
...
.pdf-placeholder{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:48px 20px;color:var(--t3);text-align:center;}
...
.page-wrap{display:flex;flex-direction:column;min-height:calc(100vh - 56px)}
.page-hd{
...
.notes-card-hd{display:flex;align-items:center;gap:7px;padding:9px 14px;border-bottom:1px solid var(--brd);background:var(--sur2);font-size:12px;font-weight:600;color:var(--t2);}
.notes-ta{width:100%;border:none;outline:none;resize:vertical;padding:12px 14px;font-size:14px;min-height:90px;font-family:'Sarabun','Noto Sans Thai',sans-serif;color:var(--t1);background:var(--sur);line-height:1.6;}
...
.fname-row{display:flex;align-items:center;gap:8px;background:var(--sur);border:1.5px solid var(--brd);border-radius:10px;padding:9px 13px;}
.fname-row label{font-size:12px;font-weight:600;color:var(--t3);white-space:nowrap;flex-shrink:0}
.fname-row input{flex:1;border:none;outline:none;font-size:14px;font-family:'Sarabun','Noto Sans Thai',sans-serif;color:var(--t1);background:transparent;min-width:0;}
